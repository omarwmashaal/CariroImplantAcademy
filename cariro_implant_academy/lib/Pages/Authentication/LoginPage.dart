...
class _LoginWidget extends StatelessWidget {
  _LoginWidget({Key? key, required this.onLogin, required this.email, required this.password, required this.onChange}) : super(key: key);
  String email;
  String password;
  Function onLogin;
  Function(String email, String password) onChange;
        ...
        children: [
          ...
          Padding(
            ...
            child: CIA_TextFormField(
              ...
              onSubmit: (value) => onLogin(email, password),
              label: "Email",
          ...
          CIA_PrimaryButton(label: "Login", onTab: () => onLogin(email, password)),
        ],
      ),
    );
  }
