...
class _PatientMedicalInfoPageState extends State<PatientMedicalInfoPage> {
  ...
  Widget build(BuildContext context) {
    List<Widget> pages = [
      _PatientMedicalHistory(patientId: widget.patientId),
                    ...
                    return StatefulBuilder(
                      builder: (context, _setState) {
                        return CIA_MedicalPagesWidget(children: () {
                          ...
                          r.add(CIA_PrimaryButton(
                              label: "Save",
                              onTab: () async {
                                await MedicalAPI.UpdatePatientProstheticTreatmentDiagnostic(widget.patientId, diagnosticModel!);
                                setState(() {});
                              }));
                          r.add(CIA_PrimaryButton(
                              label: "Refresh",
