...
import '../../../domain/patients/usecases/addToMyPatientsUseCase.dart';
...
class AddToMyPatientsRangeBloc extends Cubit<AddToMyPatientsRangeBloc_States> {
  ...
  AddToMyPatientsRangeBloc({required this.addRangeUseCase, required this.addToMyPatientsUseCase}) : super(InitialState());
