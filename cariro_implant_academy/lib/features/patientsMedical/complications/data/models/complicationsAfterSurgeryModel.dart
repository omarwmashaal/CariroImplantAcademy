...
class ComplicationsAfterSurgeryModel extends ComplicationsAfterSurgeryEntity {
  ...
  factory ComplicationsAfterSurgeryModel.fromJson(Map<String, dynamic> json) {
    return ComplicationsAfterSurgeryModel(
      ...
      tooth: json['tooth'],
      name: json['defaultSurgicalComplication']?['name'],
      defaultId: json['defaultSurgicalComplicationsId'],
      notes: json['notes'],
  ...
  Map<String, dynamic> toJson() {
    return {
      'id': id,
      'patientId': patientId,
      'defaultSurgicalComplicationsId': defaultId,
      'swelling': swelling ?? false,
      'implantFailed': implantFailed ?? false,
