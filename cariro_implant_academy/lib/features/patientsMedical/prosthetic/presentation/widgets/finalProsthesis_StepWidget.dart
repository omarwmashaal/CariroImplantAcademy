        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              FormTextValueWidget(
                text: widget.data.fullArchLower == true || widget.data.fullArchUpper == true
                    ? (widget.data.cementRetained == true
                        ? "Cement Retained"
                  ...
                  children: [
                    ...
                    Expanded(
                      child: CIA_DropDownSearchBasicIdName(
                        ...
                        searchParams: GetProstheticMaterialParams(itemId: widget.data.itemId!, type: EnumProstheticType.Final),
                        selectedItem: () {
                    ...
                    Expanded(
                      child: CIA_DropDownSearchBasicIdName(
                        ...
                        searchParams: GetProstheticTechniqueParams(itemId: widget.data.itemId!, type: EnumProstheticType.Final),
                        selectedItem: () {
